    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="py-6 sm:py-8 bg-slate-50 border-b">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-wrap justify-center gap-2 sm:gap-4 text-sm">
                        <Link href="/home-insurance/best" className="text-blue-600 hover:text-blue-700 font-medium">Best Companies</Link>
                        <span className="text-slate-300 hidden sm:inline">|</span>
                        <Link href="/home-insurance/cost" className="text-blue-600 hover:text-blue-700 font-medium">Average Cost</Link>
                        <span className="text-slate-300 hidden sm:inline">|</span>
                        <Link href="/home-insurance/how-much" className="text-blue-600 hover:text-blue-700 font-medium">How Much Do You Need?</Link>
                        <span className="text-slate-300 hidden sm:inline">|</span>
                        <Link href="/home-insurance/cheap" className="text-blue-600 hover:text-blue-700 font-medium">Cheap Home Insurance</Link>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 sm:py-16 lg:py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-8 sm:mb-12 text-center">What Does Home Insurance Cover?</h2>
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-slate-50">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-6 sm:mb-8 text-center">Top Home Insurance Companies</h2>
            ...
            <section className="py-12 sm:py-16 lg:py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 sm:mb-6 text-center">Average Cost of Home Insurance</h2>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            <div className="bg-slate-50 rounded-xl p-4 sm:p-6 text-center sm:col-span-2 lg:col-span-1">
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-slate-50">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto">
                        <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-8 sm:mb-12 text-center">Home Insurance FAQ</h2>
                            ...
                            {[
                                ...
                                <details key={index} className="bg-white rounded-xl border border-slate-200 overflow-hidden group">
                                    <summary className="p-4 sm:p-6 cursor-pointer font-semibold text-slate-900 hover:bg-slate-50 transition flex items-center justify-between text-sm sm:text-base">
                                        {faq.q}
                                        <svg className="w-5 h-5 text-slate-400 group-open:rotate-180 transition-transform flex-shrink-0 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                        </svg>
                                    </summary>
                                    <div className="px-4 sm:px-6 pb-4 sm:pb-6 text-slate-600 text-sm sm:text-base">{faq.a}</div>
                                </details>
                            ))}
                        </div>
                    </div>
            ...
            <section className="py-12 sm:py-16 bg-gradient-to-r from-blue-600 to-blue-700">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Protect Your Home Today</h2>
