...
import {
    ...
    ArrowRight, Car, Home, Dog, Briefcase, Plane, Zap, Smartphone, Truck, Umbrella
} from 'lucide-react';
...
export default function HealthInsuranceTemplate({
    ...
    return (
        <article className="min-h-screen bg-white pb-16 md:pb-0" itemScope itemType="https://schema.org/Article">
            {/* JSON-LD Schemas */}
            ...
            <header className="bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 text-white py-10 sm:py-12 md:py-16 lg:py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
                        <div>
                            <div className="flex items-center gap-2 text-emerald-400 text-xs sm:text-sm font-medium mb-3">
                                <MapPin size={14} className="sm:w-4 sm:h-4" />
                                <span>{stateName} Health Insurance Guide</span>
                            </div>
                            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight" itemProp="headline">
                                Health Insurance in {stateName}
                            </h1>
                            <p className="text-slate-300 text-sm sm:text-base md:text-lg mb-6 max-w-xl leading-relaxed" itemProp="description">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <Link href="#compare" className="bg-emerald-600 hover:bg-emerald-700 text-white px-5 sm:px-6 py-3 rounded-lg font-semibold transition-colors inline-flex items-center justify-center sm:justify-start gap-2 text-sm sm:text-base">
                                    Compare Plans <ChevronDown size={18} />
                                </Link>
                                <a href="tel:18552052412" className="bg-white/10 hover:bg-white/20 text-white px-5 sm:px-6 py-3 rounded-lg font-semibold transition-colors inline-flex items-center justify-center sm:justify-start gap-2 border border-white/20 text-sm sm:text-base">
                                    <Phone size={18} /> Speak with Agent
                                </a>
                            </div>
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 sm:mt-8 text-xs sm:text-sm font-medium text-slate-300">
                                <div className="flex items-center gap-2"><Shield className="text-emerald-400 flex-shrink-0" size={16} /><span>Compare Top Providers</span></div>
                                <div className="flex items-center gap-2"><CheckCircle className="text-emerald-400 flex-shrink-0" size={16} /><span>Free Quotes</span></div>
                                <div className="hidden sm:flex items-center gap-2"><Shield className="text-emerald-400 flex-shrink-0" size={16} /><span>Secure & Private</span></div>
                            </div>
                        </div>
            ...
            {/* Enrollment Urgency Banner - Mobile-First */}
            <section className="bg-gradient-to-r from-amber-500 to-orange-500 text-white py-3 sm:py-4">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 text-center sm:text-left">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-sm sm:text-base">Open Enrollment: {enrollmentPeriod}</span>
                        </div>
                        <span className="hidden sm:inline">|</span>
                        <span className="text-xs sm:text-sm">Don't miss your chance to enroll or change plans!</span>
                        <Link href="#compare" className="bg-white text-orange-600 px-4 py-1.5 sm:py-2 rounded-full font-semibold text-xs sm:text-sm hover:bg-orange-50 transition-colors mt-2 sm:mt-0">
                            Compare Plans Now
                        </Link>
                    </div>
                </div>
            ...
            {/* Key Takeaways - Mobile-First */}
            <section className="py-6 sm:py-8 bg-emerald-50 border-b border-emerald-200">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-3">
                            <h2 className="text-base sm:text-lg font-bold text-emerald-900 flex items-center gap-2">
                                <Heart size={18} className="sm:w-5 sm:h-5" /> Key Takeaways
                            </h2>
                        ...
                        <ul className="space-y-2">
                            {keyTakeaways.map((item, i) => (
                                <li key={i} className="flex items-start gap-2 text-emerald-800 text-sm sm:text-base">
                                    <span className="text-emerald-600 mt-1 flex-shrink-0">•</span>{item}
                                </li>
                            ))}
                        </ul>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 md:py-16">
                <div className="grid lg:grid-cols-4 gap-6 lg:gap-8">
                    ...
                    <main className="lg:col-span-3 space-y-10 sm:space-y-12 md:space-y-16">
                        {/* Flow Diagram - Mobile-First */}
                        <section className="bg-slate-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8">
                            <h2 className="text-lg sm:text-xl font-bold text-center text-slate-900 mb-6 sm:mb-8">How to Get Health Coverage</h2>
                                ...
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-2 sm:gap-4">
                                        <div className="flex flex-col items-center">
                                            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-emerald-600 rounded-full flex items-center justify-center text-white mb-2 shadow-lg">
                        ...
                        <section className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                            <div className="bg-white border rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                                <DollarSign size={20} className="mx-auto text-emerald-600 mb-2 sm:w-6 sm:h-6" />
                                <p className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900">{avgPremium}</p>
                                <p className="text-xs sm:text-sm text-slate-500">Avg. Premium</p>
                            </div>
                            <div className="bg-white border rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                                <Calendar size={20} className="mx-auto text-emerald-600 mb-2 sm:w-6 sm:h-6" />
                                <p className="text-sm sm:text-base md:text-lg font-bold text-slate-900">{enrollmentPeriod}</p>
                                <p className="text-xs sm:text-sm text-slate-500">Open Enrollment</p>
                            </div>
                            <div className="bg-white border rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <p className="text-xs sm:text-sm text-slate-500">Uninsured Rate</p>
                            </div>
                            <div className="bg-white border rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                                <Star size={20} className="mx-auto text-yellow-500 mb-2 sm:w-6 sm:h-6" />
                                <p className="text-xs sm:text-sm md:text-base font-bold text-slate-900 truncate">{topPlan}</p>
                                <p className="text-xs sm:text-sm text-slate-500">Top Plan</p>
                            </div>
                        </section>

                        {/* Coverage Options - Mobile-First */}
                        <section id="coverage-options" aria-labelledby="coverage-heading" className="prose prose-slate max-w-none">
                            <h2 id="coverage-heading" className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-4 flex items-center gap-2">
                                <Heart className="text-emerald-600 flex-shrink-0" size={24} />
                            ...
                            <h3 className="text-base sm:text-lg md:text-xl font-bold text-slate-900 mt-6 sm:mt-8 mb-4">Your Coverage Options</h3>
                            <p className="text-slate-600 leading-relaxed text-sm sm:text-base">{requirementsContent}</p>

                            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4 mt-6 not-prose">
                        ...
                        {/* Plan Types - Mobile-First Grid */}
                        <section id="plan-types" aria-labelledby="plan-types-heading">
                            <h2 id="plan-types-heading" className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-4 sm:mb-6 flex items-center gap-2">
                                <Stethoscope className="text-emerald-600 flex-shrink-0" size={24} />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                {planTypes.map((plan, i) => (
                                    <div key={i} className="bg-white border rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                                        <div className="bg-emerald-50 px-4 sm:px-5 py-3 sm:py-4 border-b border-emerald-100">
                                            <h3 className="text-lg sm:text-xl font-bold text-slate-900">{plan.name}</h3>
                                            <p className="text-xs sm:text-sm text-slate-600">{plan.fullName}</p>
                                        </div>
                                        <div className="px-4 sm:px-5 py-4">
                                            ...
                                            <div className="pt-3 border-t border-slate-100">
                                                <p className="text-xs text-slate-400 uppercase mb-1">Best For</p>
                                                <p className="text-xs sm:text-sm font-medium text-slate-700">{plan.bestFor}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                        ...
                        {/* Metal Tiers - Mobile-First with Scroll */}
                        <section id="metal-tiers" aria-labelledby="metal-tiers-heading">
                            <h2 id="metal-tiers-heading" className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-4 sm:mb-6 flex items-center gap-2">
                                <BadgePercent className="text-emerald-600 flex-shrink-0" size={24} />
                                ...
                                <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm min-w-[600px]">
                                    <thead>
                                        <tr className="bg-slate-100">
                                            <th className="px-3 sm:px-4 py-3 text-left text-xs sm:text-sm font-semibold text-slate-700">Tier</th>
                                            <th className="px-3 sm:px-4 py-3 text-left text-xs sm:text-sm font-semibold text-slate-700">Cost Split</th>
                                            <th className="px-3 sm:px-4 py-3 text-left text-xs sm:text-sm font-semibold text-slate-700">Premium</th>
                                            <th className="px-3 sm:px-4 py-3 text-left text-xs sm:text-sm font-semibold text-slate-700">Out-of-Pocket</th>
                                            <th className="px-3 sm:px-4 py-3 text-left text-xs sm:text-sm font-semibold text-slate-700">Best For</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {metalTiers.map((tier, i) => (
                                            <tr key={i} className="border-t border-slate-100 hover:bg-slate-50">
                                                ...
                                                <td className="px-3 sm:px-4 py-3 text-xs sm:text-sm text-slate-600">{tier.split}</td>
                                                <td className="px-3 sm:px-4 py-3 text-xs sm:text-sm text-slate-600">{tier.premium}</td>
                                                <td className="px-3 sm:px-4 py-3 text-xs sm:text-sm text-slate-600">{tier.outOfPocket}</td>
                                                <td className="px-3 sm:px-4 py-3 text-xs sm:text-sm text-slate-600">{tier.bestFor}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                            ...
                            <div className="mt-4 p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <p className="text-blue-800 text-xs sm:text-sm"><strong>Pro Tip:</strong> Silver plans are often the best value for those who qualify for Cost-Sharing Reductions (CSRs).</p>
                            </div>
                        </section>

                        {/* Financial Assistance - Mobile-First Grid */}
                        <section id="subsidies" aria-labelledby="subsidies-heading">
                            <h2 id="subsidies-heading" className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-4 sm:mb-6 flex items-center gap-2">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                                <div className="bg-green-50 border border-green-200 rounded-xl p-4 sm:p-6">
                                    <h3 className="font-bold text-slate-900 mb-3 flex items-center gap-2 text-sm sm:text-base">
                                        <BadgePercent className="text-green-600 flex-shrink-0" size={18} /> Premium Tax Credits
                                    </h3>
                                    <p className="text-slate-600 text-xs sm:text-sm mb-4">Lower your monthly premium based on income. Available for those earning up to ~$58,000/year (400% FPL).</p>
                                ...
                                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 sm:p-6">
                                    <h3 className="font-bold text-slate-900 mb-3 flex items-center gap-2 text-sm sm:text-base">
                                        <FileText className="text-blue-600 flex-shrink-0" size={18} /> Cost-Sharing Reductions
                                    </h3>
                                    <p className="text-slate-600 text-xs sm:text-sm mb-4">Lower deductibles and copays. Only available with Silver plans for those earning up to 250% FPL.</p>
                                ...
                                <div className={`border rounded-xl p-4 sm:p-6 ${medicaidExpansionState ? 'bg-emerald-50 border-emerald-200' : 'bg-orange-50 border-orange-200'}`}>
                                    <h3 className="font-bold text-slate-900 mb-3 flex items-center gap-2 text-sm sm:text-base">
                                        <Heart className={medicaidExpansionState ? 'text-emerald-600 flex-shrink-0' : 'text-orange-600 flex-shrink-0'} size={18} /> Medicaid
                                    </h3>
                                ...
                                <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 sm:p-6">
                                    <h3 className="font-bold text-slate-900 mb-3 flex items-center gap-2 text-sm sm:text-base">
                                        <Users className="text-purple-600 flex-shrink-0" size={18} /> CHIP
                                    </h3>
                                    <p className="text-slate-600 text-xs sm:text-sm mb-4">Free or low-cost coverage for children in families that earn too much for Medicaid.</p>
                        ...
                        {/* Compare Providers - Mobile-First */}
                        <section id="compare" aria-labelledby="compare-heading">
                            <h2 id="compare-heading" className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-2 text-center">Compare Health Insurance Providers</h2>
                            <p className="text-slate-500 text-center mb-6 sm:mb-8 text-sm sm:text-base">Get quotes from trusted carriers</p>
                            <div className="space-y-3 sm:space-y-4">
                                {affiliates.length > 0 ? affiliates.map((partner: any) => (
                                    <a key={partner.id} href={partner.affiliateUrl || '#'} target="_blank" rel="noopener noreferrer sponsored"
                                       className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white rounded-xl border hover:shadow-lg hover:border-emerald-300 transition-all group">
                                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-slate-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                            {partner.logo ? <img src={partner.logo} alt={partner.name} className="w-8 h-8 sm:w-12 sm:h-12 object-contain" /> : <span className="text-lg sm:text-2xl font-bold text-slate-400">{partner.name[0]}</span>}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <h3 className="font-semibold text-slate-900 group-hover:text-emerald-600 text-sm sm:text-base truncate">{partner.name}</h3>
                                            <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-500">
                                                <span className="flex text-yellow-400 text-xs">★★★★★</span>
                                                <span className="hidden sm:inline truncate">{partner.description || 'Health insurance provider'}</span>
                                            </div>
                                        </div>
                                        <button className="bg-emerald-600 text-white px-3 sm:px-4 py-2 rounded-lg font-medium text-xs sm:text-sm group-hover:bg-emerald-700 transition-colors flex items-center gap-1 flex-shrink-0">
                                    ...
                                    <div className="text-center py-6 sm:py-8 bg-slate-50 rounded-xl">
                                        <p className="text-slate-500 mb-2 text-sm sm:text-base">Compare health plans to find the best coverage</p>
                                        <Link href="/get-quote" className="text-emerald-600 hover:underline inline-flex items-center gap-1 text-sm sm:text-base">Get a personalized quote <ExternalLink size={14} /></Link>
                                    </div>
                                )}
                            </div>
                        </section>
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                {tipsContent.map((tip: string, i: number) => (
                                    <div key={i} className="flex items-start gap-3 bg-green-50 rounded-lg p-3 sm:p-4 border border-green-100">
                                        <span className="w-6 h-6 sm:w-7 sm:h-7 bg-green-600 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0">{i + 1}</span>
                                        <p className="text-slate-700 text-sm sm:text-base leading-relaxed">{tip}</p>
                                    </div>
                                ))}
                            </div>
                        </section>
            ...
            {/* Related Links - Mobile-First Professional Grid */}
                ...
                <section className="py-10 sm:py-12 md:py-16 bg-gradient-to-b from-slate-50 to-white border-t border-slate-100">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-8 sm:mb-12">
                            <span className="inline-block px-3 sm:px-4 py-1.5 bg-emerald-100 text-emerald-700 text-xs font-bold uppercase tracking-wider rounded-full mb-3 sm:mb-4">
                                Discover More Coverage Options
                            </span>
                            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 mb-3">Explore Related Insurance</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
                            {relatedLinks.nearbyCities?.length > 0 && (
                                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:border-emerald-200 transition-all duration-300">
                                    <div className="flex items-center gap-3 mb-4 sm:mb-5">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/20">
                                    ...
                                    <ul className="space-y-1 sm:space-y-2">
                                        {relatedLinks.nearbyCities.slice(0, 8).map((link: any, i: number) => (
                                            <li key={i}>
                                                <Link href={link.href} className="group flex items-center gap-2 sm:gap-3 p-2 sm:p-2.5 rounded-lg hover:bg-emerald-50 transition-colors">
                                                    <span className="w-5 h-5 sm:w-6 sm:h-6 bg-slate-100 group-hover:bg-emerald-100 rounded-full flex items-center justify-center transition-colors flex-shrink-0">
                                                        <ChevronRight size={12} className="sm:w-4 sm:h-4 text-slate-400 group-hover:text-emerald-600" />
                                                    </span>
                                                    <span className="text-xs sm:text-sm font-medium text-slate-600 group-hover:text-emerald-700 transition-colors truncate">{link.label}</span>
                                                </Link>
                                            </li>
                                        ))}
                                    </ul>
                            ...
                            {relatedLinks.otherNiches?.length > 0 && (
                                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300">
                                    <div className="flex items-center gap-3 mb-4 sm:mb-5">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
                                            <Shield size={18} className="sm:w-6 sm:h-6 text-white" />
                                        </div>
                                        <div>
                                    ...
                                    <ul className="space-y-1 sm:space-y-2">
                                        {relatedLinks.otherNiches.slice(0, 6).map((link: any, i: number) => (
                                            <li key={i}>
                                                <Link href={link.href} className="group flex items-center gap-2 sm:gap-3 p-2 sm:p-2.5 rounded-lg hover:bg-blue-50 transition-colors">
                                                    <span className="w-5 h-5 sm:w-6 sm:h-6 bg-slate-100 group-hover:bg-blue-100 rounded-full flex items-center justify-center transition-colors flex-shrink-0 text-xs text-slate-500 group-hover:text-blue-600">
                            ...
                            {relatedLinks.parentLocations?.length > 0 && (
                                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:border-violet-200 transition-all duration-300">
                                    <div className="flex items-center gap-3 mb-4 sm:mb-5">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-violet-500 to-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/20">
                                            <Globe size={18} className="sm:w-6 sm:h-6 text-white" />
                                        </div>
                                        <div>
                                    ...
                                    <ul className="space-y-1 sm:space-y-2">
                                        {relatedLinks.parentLocations.map((link: any, i: number) => (
                                            <li key={i}>
                                                <Link href={link.href} className="group flex items-center gap-2 sm:gap-3 p-2 sm:p-2.5 rounded-lg hover:bg-violet-50 transition-colors">
                                                    <span className="w-5 h-5 sm:w-6 sm:h-6 bg-slate-100 group-hover:bg-violet-100 rounded-full flex items-center justify-center transition-colors flex-shrink-0">
                                                        <ChevronRight size={12} className="sm:w-4 sm:h-4 text-slate-400 group-hover:text-violet-600" />
                                                    </span>
            ...
            {/* Mobile Sticky CTA - Touch-Friendly */}
            <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white py-3 sm:py-4 px-4 shadow-lg z-50 lg:hidden">
                <div className="flex items-center justify-between max-w-xl mx-auto">
                    <div className="flex items-center gap-2">
                        <Phone size={18} className="sm:w-5 sm:h-5" />
                        <span className="font-semibold text-sm sm:text-base">1-855-205-2412</span>
                    </div>
                    <a href="tel:18552052412" className="bg-white text-emerald-600 px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg font-semibold text-sm sm:text-base hover:bg-emerald-50 transition-colors">
                        Call Now
                    </a>
                </div>
            </div>
