...
export const metadata = {
    title: 'Best Commercial Auto Insurance Companies 2024 | InsuranceBuddies',
    description: 'Compare the best commercial auto insurance companies for your business vehicles and fleet.',
};

const companies = [
    { rank: 1, name: 'Progressive Commercial', rating: 4.7, bestFor: 'Small fleets' },
    { rank: 2, name: 'State Farm', rating: 4.6, bestFor: 'Local businesses' },
    { rank: 3, name: 'Nationwide', rating: 4.5, bestFor: 'Large fleets' },
    { rank: 4, name: 'GEICO Commercial', rating: 4.4, bestFor: 'Online quotes' },
    { rank: 5, name: 'Liberty Mutual', rating: 4.3, bestFor: 'Customization' },
];

export default async function BestCommercialAutoPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="bg-gradient-to-br from-[#0B1B34] via-[#0F2847] to-[#1A3A5C] py-16 sm:py-20">
                <div className="container mx-auto px-4 sm:px-6 text-center">
                    ...
                    <p className="text-lg sm:text-xl text-white/70 max-w-2xl mx-auto px-2 sm:px-0">
                        Find the best commercial auto insurance for your business vehicles.
                    </p>
                </div>
            </section>
            ...
            <section className="py-12 sm:py-16 bg-gradient-to-r from-blue-600 to-blue-700">
                <div className="container mx-auto px-4 sm:px-6 text-center">
                    <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4">Get Commercial Auto Quotes</h2>
                    <p className="text-blue-100 mb-6 sm:mb-8 text-sm sm:text-base">Compare rates for your business vehicles.</p>
