    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="max-w-4xl mx-auto space-y-6">
                        {bestCompanies.map((company) => (
                            <div key={company.rank} className={`bg-white rounded-xl border ${company.rank === 1 ? 'border-teal-500 ring-2 ring-teal-500/20' : 'border-slate-200'} p-6`}>
                                {company.rank === 1 && (
                                    <div className="text-teal-600 text-sm font-semibold mb-4">🏆 BEST OVERALL</div>
                                )}
            ...
            <section className="py-16 bg-gradient-to-r from-teal-600 to-teal-700">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl font-bold text-white mb-4">Compare Home Insurance Quotes</h2>
                    <p className="text-teal-100 mb-8">Find the best coverage for your home.</p>
