...
import { HelpCircle, Search, ChevronDown, Phone, Mail, MessageSquare, Shield, DollarSign, FileText, Clock } from 'lucide-react';
...
const faqCategories = [
    {
        ...
        faqs: [
            ...
            {
                question: 'How does MyInsuranceBuddies work?',
            ...
            {
                question: 'Is MyInsuranceBuddies available in my state?',
...
export default function FAQPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 py-20 overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <div className="max-w-xl mx-auto relative">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                        />
                    </div>
                </div>
            </section>
                    ...
                    <div className="container mx-auto px-4 max-w-4xl">
                        ...
                        {filteredFaqs.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <p className="text-slate-500">No matching questions found. Try different keywords or browse categories below.</p>
                            </div>
                        ) : (
                                ...
                                {filteredFaqs.map((faq) => (
                                    <div key={faq.id} className="bg-slate-50 rounded-xl border border-slate-200 overflow-hidden">
                                        <button
                                            ...
                                            className="w-full px-6 py-5 text-left flex items-start justify-between gap-4 hover:bg-slate-100 transition"
                                        >
                                            <div>
            ...
            <section className="py-16 bg-white border-t border-slate-200">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center mb-12">
                        ...
                        <p className="text-slate-600 text-lg">Our team of insurance experts is here to help you find the answers you need.</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                        <a href="tel:1-855-205-2412" className="group bg-slate-50 rounded-2xl p-6 text-center hover:bg-blue-50 hover:border-blue-200 border-2 border-transparent transition-all">
                            ...
                            <p className="text-slate-500 text-sm mb-3">Mon-Fri, 8am-8pm ET</p>
                            <span className="text-blue-600 font-bold">1-855-205-2412</span>
                        </a>
                        <a href="mailto:support@myinsurancebuddies.com" className="group bg-slate-50 rounded-2xl p-6 text-center hover:bg-emerald-50 hover:border-emerald-200 border-2 border-transparent transition-all">
                            ...
                            <p className="text-slate-500 text-sm mb-3">Response within 24 hours</p>
                            <span className="text-emerald-600 font-bold">support@myinsurancebuddies.com</span>
                        </a>
                        <Link href="/contact" className="group bg-slate-50 rounded-2xl p-6 text-center hover:bg-violet-50 hover:border-violet-200 border-2 border-transparent transition-all">
                            <div className="w-14 h-14 bg-violet-100 text-violet-600 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-violet-600 group-hover:text-white transition-colors">
                                <MessageSquare className="w-6 h-6" />
                            </div>
                            <h3 className="font-bold text-slate-900 mb-2">Contact Form</h3>
                            <p className="text-slate-500 text-sm mb-3">Send us a message</p>
                            <span className="text-violet-600 font-bold">Get in Touch</span>
                        </Link>
                    </div>
                </div>
            </section>
